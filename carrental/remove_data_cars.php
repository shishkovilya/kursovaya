...
<html>
    ...
    <body>
        <div class='wrapper'>
            <div id='article'>
				<form action='remove_cars.php' method='post'>
					<fieldset>
							...
							<label for='car'>Машины: </label><br><select name='car' id='car'>
								<?php
									for($i = 0;$i < count($all); $i = $i+1)
									{
										...
										if ($result)
										{
											echo "<option value='".$all[$i][0]."'>ID машины: ".$val[$i][0].", Название машины: ".$val[$i][1].", Вин номер: ".$val[$i][2].", Цена за час: ".$val[$i][3]."</option>";
										}
									}
								?>
								</select><br>
