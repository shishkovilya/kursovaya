...
<html>
    ...
    <body>
        <div class='wrapper'>
            <div id='article'>
				<form action='change_workers.php' method='post'>
					<fieldset>
								...
								<?php
									for($i = 0;$i < count($all); $i = $i+1)
									{
										...
										if ($result)
										{
											...
											echo "<option value='".$all[$i][0]."'>ID работника: ".$val[$i][0].", ФИО работника: ".$val[$i][1].", Должность: ".$f[0][0].", Адрес работника: ".$val[$i][3]."</option>";
										}
									}
								?>
								</select><br>
